package com.mauriciocepeda.servlet.demo;
...
import com.mauriciocepeda.service.demo.WelcomeService;
...
public class WelcomeServletNew extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<String> welcomeMessage = welcomeService.getWelcomeMessage("Mauricio Cepeda");
